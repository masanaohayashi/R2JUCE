...
<JUCER_COMPONENT documentType="Component" className="R2AlertComponent" componentName=""
                 parentClasses="public juce::Component" constructorParams="juce::Component* parent, const juce::String&amp; title, const juce::String&amp; message, const juce::StringArray&amp; buttonLabels, bool showProgressBar, std::function&lt;void(int)&gt; callback"
